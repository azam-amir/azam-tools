...
export const tools = [
  {
    ...
    icon: <FaFilePdf className="text-red-600 text-[28px] flex" />,
  ...
  },
  {
    ...
    icon: <FaImage className="text-blue-500 text-[28px] flex" />,
  ...
  },
  {
    ...
    icon: <FaTextHeight className="text-green-600 text-[28px] flex" />,
  ...
  },
  {
    ...
    icon: <FaQrcode className="text-purple-600 text-[28px] flex" />,
  ...
  },
  {
    ...
    icon: <FaCode className="text-orange-500 text-[28px] flex" />,
  ...
  },
  {
    ...
    icon: <FaLock className="text-gray-700 text-[28px] flex" />,
